...
int main() {
    ...
    case 5: {
        ...
        do {
            ...
            int strategyOption;
            do {
                std::cout << "Pasirinkite, kuri strategija naudoti studentu skaidymui:\n";
                std::cout << "1 - Strategija 1 (kopijuojant i du naujus list)\n";
                std::cout << "2 - Strategija 2 (perkeliant 'neislaike' ir trinant is originalaus list)\n";
                std::cout << "3 - Strategija 3 (naudojant std::list::splice)\n";
            ...
            do {
                ...
                std::cout << "1 - Rikiuoti mazejimo tvarka\n";
                std::cout << "2 - Rikiuoti didejimo tvarka\n";
                std::cout << "Iveskite pasirinkima: ";
                std::cin >> sortOption;
            ...
            if (strategyOption == 4) {
                std::list<Studentas> temp;

                for (auto& studentas : studentai) {
                    studentas.finalGrade = calculateFinalGrade(studentas, pasirinkimas);
                }
                ...
                if (strategyOption == 1) {
                    ...
                    writeResultsToFile(neislaike, "neislaike.txt", gradeCalculationOption, sortOption);
                    writeResultsToFile(islaike, "islaike.txt", gradeCalculationOption, sortOption);
                }
                else if (strategyOption == 2) {
                    strategija2(studentai, neislaike);
                    writeResultsToFile(neislaike, "neislaike.txt", gradeCalculationOption, sortOption);
                    writeResultsToFile(studentai, "islaike.txt", gradeCalculationOption, sortOption);
                }
