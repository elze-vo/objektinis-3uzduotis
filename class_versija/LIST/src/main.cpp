...
int main() {
    ...
    case 1: {
        ...
        do {
            ...
            if (!inputFile.is_open()) {
                ...
                } while (gradeCalculationOption < 1 || gradeCalculationOption > 2);

                for (auto& studentas : studentai) {
                    studentas.setFinalGrade(calculateFinalGrade(studentas, gradeCalculationOption));
                }
    ...
    case 5: {
        ...
        do {
            ...
            } while (strategyOption < 1 || strategyOption > 4);
            ...
            if (strategyOption == 4) {
                std::list<Studentas> temp = studentai;
                for (int i = 1; i < 4; ++i) {
                    switch (i) {
                ...
                writeResultsToFile(neislaike, "neislaike.txt", sortOption);
                writeResultsToFile(islaike, "islaie.txt", sortOption);
            }
